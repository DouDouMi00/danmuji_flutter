        ...
        child: ListView(
          children: [
            ...
            SwitchListTile(
              ...
              value:
                  configMap.dynamicConfig.filter.danmu.readfansMedalGuardLevel,
              onChanged: (value) async {
                setState(() {
                  configMap.dynamicConfig.filter.danmu.readfansMedalGuardLevel =
                      value;
            ...
            SwitchListTile(
              ...
              value:
                  configMap.dynamicConfig.filter.danmu.isFansMedalBelongToLive,
              onChanged: (value) async {
                setState(() {
                  configMap.dynamicConfig.filter.danmu.isFansMedalBelongToLive =
                      value;
              ...
              onTap: () {
                Get.toNamed(
                  ...
                  arguments: EditableListParams(
                    title: '黑名单关键词',
                    initialValue:
                        configMap.dynamicConfig.filter.danmu.blacklistKeywords,
              ...
              onTap: () {
                Get.toNamed(
                  ...
                  arguments: EditableListParams(
                    title: '白名单关键词',
                    initialValue:
                        configMap.dynamicConfig.filter.danmu.whitelistKeywords,
                    inputType: InputType.stringInputType,
                    isObscured: false,
                    onSaved: (value) async {
                      setState(() {
